...
export default defineConfig({
  ...
  use: {
    baseURL: process.env.BASE_URL || 'http://localhost:3902',
    ...
    storageState: { cookies: [], origins: [{ origin: process.env.BASE_URL || 'http://localhost:3902', localStorage: [{ name: 'i18nextLng', value: 'en' }] }] },
